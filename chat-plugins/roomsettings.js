...
class RoomSettings {
	...
	slowchat() {
		if (!this.user.can('slowchat', null, this.room)) return "(Currently at: <strong>" + (this.room.slowchat ? this.room.slowchat : false) + "</strong>, but unable to change.)";
		let slowchatOutput = [];
