...
exports.commands = {
	...
	ipsearch: function (target, room, user, connection, cmd) {
		...
		if (!results.length) {
			...
			return this.parse(`/goldipsearch ${originalTarget}`);
		}
	...
	opensource: function (target, room, user) {
		...
		this.sendReplyBox(
			...
			`- <a href="https://github.com/panpawn/Gold-Server/commits/master">What's new?</a><br />` +
			...
			`- <a href="https://github.com/panpawn/Gold-Server">Gold's server source code</a><br />` +
			`- <a href="https://github.com/panpawn/Gold-Client">Gold's client source code</a><br />` +
