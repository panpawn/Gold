...
exports.commands = {
	...
	requesthelp: function (target, room, user) {
		...
		saveReports();
		Gold.pmUpperStaff('A new report has been submitted by ' + user.name + '. ID: ' + reportId + ' Message: ' + target.trim(), '~Server');
	...
	reports: function (target, room, user, connection) {
		...
		case 'accept':
			...
			Gold.pmUpperStaff(user.name + " accepted the report by " + Reports[id].reporter + ". (ID: " + id + ")", '~Server');
		...
		case 'deny':
			...
			Gold.pmUpperStaff(user.name + " denied the report by " + Reports[reportid].reporter + ". (ID: " + reportid + ")", '~Server');
		...
		case 'delete':
			...
			Gold.pmUpperStaff(user.name + " deleted the report by " + Reports[rid].reporter + ". (ID: " + rid + ")", '~Server');
